function R1 = VAevald(Z,Hes,varargin)  % Vand.+Arnoldi basis construction
% VAevald Function 
%   VAevald(Z,Hes,varargin)
%   returns only the basis vector for derivatives R1. Identical to VAeval 
%   from chebfun. Below notes are from VAeval.
%
